...
| **Маленький и быстрый** | С `opt-level = 3` + LTO + `strip` приложение весит пару мегабайт и стартует мгновенно |
...
|---|---|---|
| `MacroRecorder.exe` | Любой x86-64 | Одна сборка. Набор инструкций выбирается при старте |
